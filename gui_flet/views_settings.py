    ...
    def render(self) -> ft.Control:
        ...
        return ft.Column(
            [
                ...
                ft.Container(
                    ft.Text(
                        "Фото к заказам, печать актов, справочники и сотрудники пока "
                        "доступны только в классическом интерфейсе — переключитесь на "
                        "него из окна выбора при следующем запуске.",
