...
class IReportRepository:
    ...
    def get_report_by_id(self, report_id: int) -> GeneratedReport | None:
...
class ReportService(BaseService):
    ...
    def __init__(
        self, pdf_generator: IPDFGenerator, report_repository: IReportRepository
    ):
        self._pdf_generator = pdf_generator
        self._repo = report_repository

    def generate_report(self, command: GenerateReportCommand) -> GeneratedReport | None:
    ...
    def print_report(self, command: PrintReportCommand) -> bool:
        ...
        try:
            ...
            self.logger.info(
                f"Sending {report.file_path} to printer {command.printer_name or 'default'}"
            )
    ...
    def create_template(self, command: CreateTemplateCommand) -> ReportTemplate | None:
    ...
    def get_templates(self, template_type: str | None = None) -> list[ReportTemplate]:
        """Get active templates."""
        return self.safe_execute(
            self._repo.get_active_templates, template_type, default=[]
        )
...
class ReportsPlugin(IPlugin):
    ...
    def __init__(self):
        self._service: ReportService | None = None
        self._pdf_generator: IPDFGenerator | None = None
        self._repository: IReportRepository | None = None
    ...
    def get_api(self) -> ReportService | None:
