...
from typing import List, Dict, Any, Optional, Protocol, BinaryIO
from concurrent.futures import ThreadPoolExecutor, Future
from pathlib import Path

from shared.kernel import UnitOfWork, DateRange
...
class ReportingService:
        ...
        try:
            ...
            with self._uow_factory() as uow:
                ...
                if report_type == "excel":
                    ...
                    file_path = self._generate_pdf_report(report_id, orders, report_type)
    ...
    def _generate_csv_report(
        ...
        with open(file_path, 'w', encoding='utf-8', newline='') as f:
            writer = csv.writer(f)
            writer.writerow(["ID", "Номер", "Клиент", "Устройство", "Статус", "Сумма", "Дата"])
    ...
    def export_order_act(self, order_id: int) -> Optional[Path]:
        """
