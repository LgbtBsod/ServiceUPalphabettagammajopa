...
class PDFBuilder:
    ...
    def reorder_fields(self, section_index: int, field_order: list[int]) -> PDFBuilder:
        ...
        if 0 <= section_index < len(self.sections):
            ...
            reordered_fields = [
                section.fields[i] for i in field_order if 0 <= i < len(section.fields)
            ]
