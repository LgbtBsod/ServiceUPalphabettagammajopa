...
class DeviceFormDialog(ctk.CTkToplevel):
    ...
    def _create_main_tab_content(self, parent, device_data):
        ...
        device_frame = ctk.CTkFrame(
            left, fg_color=self.colors["bg_secondary"], corner_radius=10
        )
        ...
        # Тип
        ctk.CTkLabel(fields_frame, text="Тип*:", font=ctk.CTkFont(size=12)).grid(
            row=0, column=0, sticky="w", pady=5
        )
        self.device_type_combo = ctk.CTkComboBox(
            fields_frame,
            values=self.db.get_dict_values("device_types"),
            width=200,
            fg_color=self.colors["bg_tertiary"],
            border_color=self.colors["border"],
        )
        ...
        self.device_type_combo.bind(
            "<<ComboboxSelected>>", self._on_device_type_changed
        )

        # Бренд
        ctk.CTkLabel(fields_frame, text="Бренд:", font=ctk.CTkFont(size=12)).grid(
            row=1, column=0, sticky="w", pady=5
        )
        self.brand_combo = ctk.CTkComboBox(
            fields_frame,
            values=self.db.get_dict_values("brands"),
            width=200,
            fg_color=self.colors["bg_tertiary"],
            border_color=self.colors["border"],
        )
        ...
        # Модель
        ctk.CTkLabel(fields_frame, text="Модель*:", font=ctk.CTkFont(size=12)).grid(
            row=2, column=0, sticky="w", pady=5
        )
        self.model_entry = ctk.CTkEntry(
            fields_frame,
            width=200,
            placeholder_text="Введите модель",
            fg_color=self.colors["bg_tertiary"],
            border_color=self.colors["border"],
        )
        ...
        # S/N
        ctk.CTkLabel(fields_frame, text="S/N:", font=ctk.CTkFont(size=12)).grid(
            row=3, column=0, sticky="w", pady=5
        )
        self.serial_entry = ctk.CTkEntry(
            fields_frame,
            width=200,
            placeholder_text="Введите серийный номер",
            fg_color=self.colors["bg_tertiary"],
            border_color=self.colors["border"],
        )
        ...
        # Неисправность
        ctk.CTkLabel(
            fields_frame, text="Неисправность*:", font=ctk.CTkFont(size=12)
        ...
        # Внешний вид
        ctk.CTkLabel(fields_frame, text="Внешний вид:", font=ctk.CTkFont(size=12)).grid(
            row=5, column=0, sticky="w", pady=5
        )
        self.appearance_combo = ctk.CTkComboBox(
            fields_frame,
            values=self.db.get_dict_values("appearance"),
            width=200,
            fg_color=self.colors["bg_tertiary"],
            border_color=self.colors["border"],
        )
        ...
        # Комплектация
        ctk.CTkLabel(
            fields_frame, text="Комплектация:", font=ctk.CTkFont(size=12)
        ).grid(row=6, column=0, sticky="w", pady=5)
        self.completeness_combo = ctk.CTkComboBox(
            fields_frame,
            values=self.db.get_dict_values("completeness"),
            width=200,
            fg_color=self.colors["bg_tertiary"],
            border_color=self.colors["border"],
        )
        ...
        # Статус
        ctk.CTkLabel(fields_frame, text="Статус:", font=ctk.CTkFont(size=12)).grid(
        ...
        client_frame = ctk.CTkFrame(
            right, fg_color=self.colors["bg_secondary"], corner_radius=10
        )
        ...
        # ФИО
        ctk.CTkLabel(client_fields, text="ФИО*:", font=ctk.CTkFont(size=12)).grid(
            row=0, column=0, sticky="w", pady=5
        )
        self.client_name_entry = ctk.CTkEntry(
            client_fields,
            width=200,
            placeholder_text="Введите ФИО клиента",
            fg_color=self.colors["bg_tertiary"],
            border_color=self.colors["border"],
        )
        ...
        # Статус клиента
        ctk.CTkLabel(
            client_fields, text="Статус клиента:", font=ctk.CTkFont(size=12)
        ...
        self.client_status_combo.grid(
            row=1, column=1, sticky="ew", pady=5, padx=(10, 0)
        )

        # Телефон
        ctk.CTkLabel(client_fields, text="Телефон*:", font=ctk.CTkFont(size=12)).grid(
            row=2, column=0, sticky="w", pady=5
        )
        self.phone_entry = ctk.CTkEntry(
            client_fields,
            width=200,
            placeholder_text="+7 (XXX) XXX-XX-XX",
            fg_color=self.colors["bg_tertiary"],
            border_color=self.colors["border"],
        )
        ...
        # Инженер
        ctk.CTkLabel(client_fields, text="Инженер:", font=ctk.CTkFont(size=12)).grid(
            row=3, column=0, sticky="w", pady=5
        )
        self.engineer_combo = ctk.CTkComboBox(
            client_fields,
            values=self.db.get_dict_values("engineers"),
            width=200,
            fg_color=self.colors["bg_tertiary"],
            border_color=self.colors["border"],
        )
        ...
        # Общая цена
        ctk.CTkLabel(client_fields, text="Общая цена:", font=ctk.CTkFont(size=12)).grid(
        ...
        # Предоплата
        ctk.CTkLabel(client_fields, text="Предоплата:", font=ctk.CTkFont(size=12)).grid(
            row=5, column=0, sticky="w", pady=5
        )
        self.prepayment_entry = ctk.CTkEntry(
            client_fields,
        ...
        # Затраты
        ctk.CTkLabel(
            client_fields, text="Затраты (₽):", font=ctk.CTkFont(size=12)
        ).grid(row=6, column=0, sticky="w", pady=5)
        self.expense_entry = ctk.CTkEntry(
            client_fields,
            width=200,
        ...
        # Приоритет
        ctk.CTkLabel(client_fields, text="Приоритет:", font=ctk.CTkFont(size=12)).grid(
            row=7, column=0, sticky="w", pady=5
        )
        self.priority_combo = ctk.CTkComboBox(
            client_fields,
        ...
        # Гарантия
        ctk.CTkLabel(client_fields, text="Гарантия:", font=ctk.CTkFont(size=12)).grid(
        ...
        # Заметки
        ctk.CTkLabel(client_fields, text="Заметки:", font=ctk.CTkFont(size=12)).grid(
