...
class WorkItemDialog(ctk.CTkToplevel):
    ...
    def __init__(
        self, parent, colors, description="", price="", quantity=1, settings=None
    ):
    ...
    def create_widgets(self, description, price, quantity):
        ...
        self.desc_entry = PremiumEntry(
            form_frame, colors=self.colors, placeholder_text="Введите описание работы"
        )
        ...
        self.price_entry = PremiumEntry(
            form_frame, colors=self.colors, placeholder_text="Например: 5000"
        )
