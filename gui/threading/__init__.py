...
class ThreadManager(LoggableMixin):
    ...
    def __init__(self):
        ...
        self.core_executor = ThreadPoolExecutor(
            max_workers=4,
            thread_name_prefix="core_worker"
        )
    ...
    def get_result(self, task_id: str) -> Optional[ThreadResult]:
    ...
    def clear_results(self, older_than: Optional[datetime] = None) -> int:
