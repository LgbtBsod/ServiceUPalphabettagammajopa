...
class LicenseService:
    ...
    def __init__(
        self,
        license_repo: LicenseRepositoryProtocol | None = None,
        hardware_info: HardwareInfoProtocol | None = None,
    ):
        ...
        if license_repo is None:
            from infrastructure.licensing.license_repository import (
    ...
    def _get_trial_start(self) -> datetime | None:
        ...
        if sys.platform == "win32":
            try:
                ...
                with winreg.OpenKey(
                    winreg.HKEY_CURRENT_USER, r"SOFTWARE\ServiceUP"
                ) as key:
