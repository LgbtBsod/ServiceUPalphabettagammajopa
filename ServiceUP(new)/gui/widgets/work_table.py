...
class WorkItemsTable:
    ...
    def __init__(self, parent, colors, work_manager, on_total_changed=None, db=None, settings=None):
        self.parent = parent
        self.colors = colors
    ...
    def create_widgets(self):
        ...
        tree_container = ctk.CTkFrame(table_frame, fg_color=self.colors['bg_tertiary'], corner_radius=6)
    ...
    def get_work_templates(self):
        ...
        try:
            ...
            return [{'description': it.get('value', ''),
