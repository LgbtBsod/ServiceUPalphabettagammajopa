...
class I18NService:
    ...
    def __init__(self, i18n_dir: str | Path | None = None):
        ...
        self._executor = ThreadPoolExecutor(max_workers=2, thread_name_prefix='i18n_loader')
    ...
    def get(self, key: str, **kwargs) -> str:
        ...
        if text is None:
            ...
            if len(key_parts) >= 2:
                ...
                section = key_parts[0] + 's' if not key_parts[0].endswith('s') else key_parts[0]
    ...
    def __enter__(self) -> I18NService:
