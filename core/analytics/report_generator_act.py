...
from infrastructure.db_access import get_db_access, DatabaseConfig
...
class ReportDataGenerator(BaseService):
    ...
    def get_orders_for_report(self, 
                             start_date: datetime,
                             end_date: datetime,
    ...
    def get_clients_for_report(self, 
    ...
    def get_work_items_for_report(self, 
                                  order_id: Optional[int] = None) -> List[Dict[str, Any]]:
