...
class Device:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> Device:
        ...
        return cls(
            ...
            receipt_date=datetime.fromisoformat(data['receipt_date']) if data.get('receipt_date') else datetime.now(),
...
class Client:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> Client:
        ...
        return cls(
            ...
            first_order_date=datetime.fromisoformat(data['first_order_date']) if data.get('first_order_date') else None,
...
class FinanceRecord:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> FinanceRecord:
        ...
        return cls(
            id=data.get('id'),
            order_number=data.get('order_number', ''),
            completion_date=datetime.fromisoformat(data['completion_date']) if data.get('completion_date') else datetime.now(),
