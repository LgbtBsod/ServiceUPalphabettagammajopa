...
class AnalyticsRepository(Protocol):
    ...
    def get_orders_by_date_range(self, date_from: date, date_to: date) -> List[Dict[str, Any]]:
...
class AnalyticsService:
    ...
    def get_revenue_trend(
        ...
        try:
            revenue_by_status = self._repository.get_revenue_by_status(start_date, end_date)
            ...
            logger.error(f"Failed to calculate revenue trend: {e}")
            return []
