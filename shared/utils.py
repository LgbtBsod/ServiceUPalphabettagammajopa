...
def extract_phone_digits(phone: str | None) -> str:
...
def validate_and_normalize_phone(phone: str | None) -> tuple[bool, str]:
...
Number = int | float | str | Decimal | None
...
def format_date(date_obj: datetime | None, format_str: str = "%d.%m.%Y") -> str:
...
def get_days_since(date_from: datetime, date_to: datetime | None = None) -> int:
